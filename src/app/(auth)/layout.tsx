export default function AuthLayout({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      <div className="absolute left-[-8%] top-[12%] size-64 rounded-full bg-primary/8 blur-3xl" />
      <div className="absolute bottom-[10%] right-[-6%] size-72 rounded-full bg-primary/6 blur-3xl" />
